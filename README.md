...
To get started, follow the setup guide for your operating system:
...
└── sql/                     # Example and tutorial SQL scripts
    └── example.sql          # Sample SQL queries for learning & testing
```

## Author

Created by Lars Kühn. If you have any problems following these guides, contact me via MS Teams or by email at lars_rolf.kuehn@edu.fhdw.de
